    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          ...
          <li>
            El número de envío no debe tener una máscara o caracteres especiales y debe estar compuesto por:
            <ul>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"5599999999999\", \"body\": \"mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
