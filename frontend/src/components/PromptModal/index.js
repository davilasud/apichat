...
const PromptSchema = Yup.object().shape({
    ...
    prompt: Yup.string().min(50, "¡Muy corto!").required("Describe la capacitación para la inteligencia artificial"),
    voice: Yup.string().required("informe Modo Para Voz"),
    max_tokens: Yup.number().required("Ingrese el número máximo de tokens"),
    temperature: Yup.number().required("informe una Temperatura"),
    apikey: Yup.string().required("Informe una API Key"),
    queueId: Yup.number().required("Informe una fila"),
    max_messages: Yup.number().required("Ingrese el número máximo de mensajes")
});
